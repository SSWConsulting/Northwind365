        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Line1 = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipAddress_Line1 = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    ShipAddress_City = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ShipAddress_Region = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ShipAddress_PostalCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ShipAddress_Country = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityPerUnit = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
